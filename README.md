  ...
  deploy:
    ...
    - uses: jakejarvis/s3-sync-action@master
      ...
      env:
        ...
        AWS_CLOUDFRONT_DISTRIBUTION: ${{ secrets.AWS_CLOUDFRONT_DISTRIBUTION }} #optional: if use cloudfront
...
| `AWS_CLOUDFRONT_DISTRIBUTION` | Your AWS clour front distribution. [More info here.](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-working-with.html) | `secret env` | **Yes** | N/A |
